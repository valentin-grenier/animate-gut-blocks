			...
			return createElement(
				...
				createElement(
					...
					createElement(
						PanelBody,
						{
							title: __('Animations', 'simple-block-animations'),
							initialOpen: true,
						},
					createElement(ToggleControl, {
						label: __('Animer le bloc', 'simple-block-animations'),
						checked: isAnimated,
							onChange: (value) => {
						...
						createElement(SelectControl, {
							label: __("Type d'animation", 'simple-block-animations'),
							value: animationType,
							options: [
								{ label: __('Fondu', 'simple-block-animations'), value: 'fade-in' },
								{ label: __('Fondu - Bas vers haut', 'simple-block-animations'), value: 'fade-in-up' },
								{ label: __('Fondu - Haut vers bas', 'simple-block-animations'), value: 'fade-in-down' },
								{ label: __('Fondu - Gauche vers droite', 'simple-block-animations'), value: 'fade-in-left' },
								{ label: __('Fondu - Droite vers gauche', 'simple-block-animations'), value: 'fade-in-right' },
								{ label: __('Zoom avant', 'simple-block-animations'), value: 'zoom-in' },
								{ label: __('Glissement vers le haut', 'simple-block-animations'), value: 'slide-up' },
							],
								onChange: (value) => {
						...
						createElement(RangeControl, {
							label: __("Durée de l'animation", 'simple-block-animations'),
							...
							max: 2,
							step: 0.1,
							help: __('Durée en secondes', 'simple-block-animations'),
							}),
						isAnimated &&
						createElement(RangeControl, {
							label: __("Délai de l'animation", 'simple-block-animations'),
